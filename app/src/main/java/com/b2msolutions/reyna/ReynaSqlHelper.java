...
public class ReynaSqlHelper extends SQLiteOpenHelper {

    public static final int DATABASE_VERSION = 1;

    private static final String TAG = "Repository";

    public ReynaSqlHelper(Context context) {
        super(context, new Preferences(context).getDbFile(), null, DATABASE_VERSION);
    }
